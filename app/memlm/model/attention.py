...
# ══════════════════════════════════════════════════════════════════════════
# Cross Attention — dùng cho Read M (không cần RoPE vì M không có vị trí)
# ══════════════════════════════════════════════════════════════════════════

class CrossAttention(nn.Module):
    """
    Multi-head cross attention: Q từ token, K/V từ Memory M.
    M không có khái niệm "vị trí trong sequence" nên không áp RoPE.
    """
    ...
    def _split_heads(self, x: torch.Tensor, W: nn.Linear) -> torch.Tensor:
        B, L, _ = x.shape
