...
if __name__ == "__main__":
    INPUT_DIRECTORY = "E:\LLM Dataset\Python_Jtatman"       # Thư mục chứa hàng trăm file 40MB ban đầu
    OUTPUT_DIRECTORY = "E:\LLM Dataset\Python_Jtatman_merged"   # Thư mục chứa các file ~500MB sau khi gom
